    ...
    <main className="gap-5 dark:bg-[#1C203B] p-3 bg-white">
      ...
      <div className="flex text-black dark:text-white justify-between py-[10px]  sm:flex-row md:flex-row xs:flex-col">
                ...
                <div className=" flex justify-end">
                    ...
                    <div className="inline text-black dark:text-white pp sm:pr-1 md:pr-1 xs:pr-1">
      ...
      {/* <ul role="list" className="grid lg:grid-cols-3  gap-3  xs:grid-cols-1 md:grid-cols-2 sm:grid-cols-2"> */}
        {/* {
